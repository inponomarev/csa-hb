...
image::intake.jpg[{image-100-width}]

[%notitle]
== Delivery Pipeline

image::water-filtration.jpg[{image-100-width}]
...
image::swampman.jpg[{image-100-width}]
...
[%notitle]
== При смене фильтров бывает грязно
image::dirty_filter.jpg[]
